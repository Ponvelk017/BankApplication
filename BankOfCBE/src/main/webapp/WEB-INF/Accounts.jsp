...
<body>
		...
		<div class="collapse navbar-collapse flex-wrap" id="navbarNav">
			<ul class="navbar-nav">
				...
				<div class="firstfive">
					...
					<div>
						<li class="nav-item top selected-link"><a class="nav-link"
				...
				<div class="lastone">
					<li class="nav-item profile"><a class="nav-link"
						href="<%=request.getContextPath()%>/SessionFilter?page=profile"><svg
								xmlns="http://www.w3.org/2000/svg" width="30" height="30"
	...
	<nav class="col-md-2  bg-light sidebar">
		<ul class="nav flex-column">
			...
			<li class="nav-item">
				<div class="nav-link nav-linka text-center">
					<button type="submit" id="statement-button"
						class="link-button selected-siderbar">
						<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
						...
						<div class="col-5 align-items-center" style="padding-top: 4%;">
							<form id="depositForm" class="text-center forms"
								...
								<input name="formType" value="deposit" type="hidden"> <label
									...
									name="accountno" class="textbox" required>
									<%
									if (accounts.size() > 1) {
									%>
						...
						<div class="col-5 align-items-center" style="padding-top: 4%;">
							<form id="interForm" class="text-center forms"
								...
								<label for="accountno">Account Number:</label> <select
									id="accountno" name="accountno" class="textbox" required>
									<%
									if (accounts.size() > 1) {
									%>
									<option value="" disabled selected hidden>--Select--</option>
									...
									Account Number:</label> <input class="textbox" type="number"
